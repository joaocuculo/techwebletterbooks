...
<div class="flex flex-col justify-center items-center w-full py-5 gap-5">
    ...
    <section class="max-w-6xl w-full flex flex-row justify-between items-center">
        <div class="flex flex-row gap-3">
            <a href="{{ route('categories.index') }}" class="underline hover:text-primary-light inline-flex items-center">
    ...
    <section class="max-w-6xl w-full flex flex-col">
        <div>
            <h1 class="text-lg font-bold tracking-widest uppercase">Dados da Categoria</h1>
        </div>
        ...
        <div class="flex flex-col gap-2">
            ...
            <div class="flex flex-row gap-2">
                <a href="{{ route('categories.edit', $category->id) }}" class="bg-primary text-slate-50 px-3 py-0.5 rounded-md w-fit hover:bg-primary-light cursor-pointer transition duration-200 shadow">Editar</a>
